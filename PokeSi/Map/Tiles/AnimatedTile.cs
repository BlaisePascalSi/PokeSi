...
namespace PokeSi.Map.Tiles
{
    public class AnimatedTile : Tile
    {
        ...
        public override Rectangle GetDestinationRect(int x, int y, int xOff, int yOff)
        {
            return DrawHelper.ExtendToContain(new Rectangle(x * Tile.Width - AnimationPlayer.CurrentSprite.Origin.X - xOff,
                                                            y * Tile.Height - AnimationPlayer.CurrentSprite.Origin.Y - yOff,
